...
function naverLengthGuide(imageCount) {
  const imagePlacement = [
    ...
    "",
    "[위젯 placeholder — 필수]",
    "- Naver 에디터가 자동 생성하는 카드형 위젯(매장/지도/카카오)은 raw chrome 으로 출력하지 말고 placeholder 한 줄만 사용해 자리만 잡는다.",
    "- `[매장 박스]` — 컬컴 하남점 주소 카드 자리 (오프닝에 첫 이미지 직후 또는 본문 끝에 위치 안내로 자주 등장)",
    "- `[지도 위젯]` — 네이버 지도 위젯 자리 (선택)",
    "- `[카카오톡 카드]` — 카카오 채널 링크 카드 자리 (CTA 끝, 카카오 안내 이미지 마커 직후)",
    "- raw chrome 형태 (`[**카카오톡** ... ](url)`, `[**네이버지도** ...](url)`, `[**컬컴 하남점** ...](#)`) 는 어떤 경우에도 출력 금지.",
    "",
    "[모델 누출 금지]",
