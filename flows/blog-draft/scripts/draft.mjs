...
function naverLengthGuide(imageCount) {
  const imagePlacement = [
    ...
    "",
    "[위젯 chrome 출력 금지]",
    "- reference 샘플에 보이는 다음 카드형 블록은 Naver 에디터가 자동 생성한다. draft 는 출력하지 말 것:",
    "  - `[**카카오톡**\\n\\npf-link.kakao.com](url)` 카카오 카드",
    "  - `[**네이버지도**\\n\\n컬컴 하남점\\n\\nmap.naver.com](url)` 지도 카드",
    "  - `[**컬컴 하남점**\\n\\n경기도 하남시 ...](#)` 매장 카드",
    "- 카카오 링크는 plain `[카카오톡](url)` 한 줄로, 매장 주소는 plain 단락 또는 인용블록(`> `) 으로 작성.",
    "",
    "[모델 누출 금지]",
