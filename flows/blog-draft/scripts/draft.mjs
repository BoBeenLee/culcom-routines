...
function naverLengthGuide(imageCount) {
  const imagePlacement = [
    ...
    "",
    "[위젯 chrome — raw 형태 그대로 출력]",
    "- 매장/지도/카카오 카드는 다음 정확한 multi-line 마크다운 링크 형태로 본문에 출력. 운영자가 그대로 네이버 에디터에 붙여넣으면 카드로 렌더된다.",
    "",
    ...
    "  ```",
    "",
    "- 위 chrome 블록의 텍스트·줄바꿈·괄호·URL 은 한 글자도 바꾸지 말 것. plain `[카카오톡](url)` 한 줄로 압축하거나 다른 query 값 사용 금지.",
    "",
    "[모델 누출 금지]",
